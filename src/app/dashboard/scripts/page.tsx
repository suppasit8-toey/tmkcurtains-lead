...
export const PROMOTIONS_DATA: ScriptItem[] = [
  ...
  {
    id: 'p_int2',
    title: 'แคมเปญทดลองติดตั้ง (Trial)',
    content: '🎓 ข้อเสนอพิเศษสำหรับโรงเรียน 🎓\n\nมั่นใจในคุณภาพ ก่อนตัดสินใจทำโปรเจกต์ใหญ่ด้วยแคมเปญทดลองติดตั้งราคาพิเศษ\n\n✨ SPECIAL TRIAL CAMPAIGN ✨\nเพียง 5,000 THB\n\nทดลองติดตั้งในงบ 5,000 บาท เพื่อทดสอบคุณภาพวัสดุและมาตรฐานการติดตั้ง ก่อนเริ่มโปรเจกต์ขนาดใหญ่\n\n✅ QUALITY YOU CAN TRUST: วัสดุคุณภาพสูง ได้มาตรฐานสากล\n✅ EXPERIENCED TEAM: ทีมงานมืออาชีพ ดูแลทุกขั้นตอน\n✅ RELIABLE AFTER-SALES SERVICE: บริการหลังการขายรวดเร็ว ใส่ใจ\n\nสนใจรับข้อเสนอพิเศษนี้ ติดต่อ:\n📞 064-179-2417\n✉️ curtains.tmk@gmail.com\n💬 LINE: @tmkcurtains',
    category: 'โรงเรียนนานาชาติ'
  },
  {
    id: 'p_uni1',
